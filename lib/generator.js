...
exports.generateLeaderBoards = function (session, data, camDrivers, configuration) {
  ...
  session.forEach(function (value) {
    ...
    cdoc = driver.currentDriverOnCamera(currentTime - configuration.camera.offset, lastTime - configuration.camera.offset, camDrivers);
    //console.log(cdoc);
...
// populate yellow flags
function populateBattles(boards, events) {
