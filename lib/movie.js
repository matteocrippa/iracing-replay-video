...
exports.prepareVideo = function (data) {
  ...
  const items = chunk(data.standings, 4);
  ...
  async.waterfall([
    ...
    function (callback) {
      generateRaceVideo(callback, items[0], video, true);
    },
    function (callback) {
      generateRaceVideo(callback, items[1], video, false);
    },
    function (callback) {
      generateRaceVideo(callback, items[2], video, false);
    },
    function (callback) {
      generateRaceVideo(callback, items[3], video, false);
    },
    function (callback) {
      ffmpeg()
